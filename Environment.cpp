...
std::string Environment::log_level() const {
    return loglvl_;
}

std::string Environment::version() const {
    return version_;
}

void Environment::set_log_level(char const * level) {
    loglvl_ = std::string(level);
}

bool Environment::use_mpi() const {
    return use_mpi_;
}

bool Environment::function_timers() const {
    return func_timers_;
}

int64_t Environment::tod_buffer_length() const {
    return tod_buffer_length_;
}

int Environment::max_threads() const {
    return max_threads_;
}

int Environment::current_threads() const {
    return cur_threads_;
}

void Environment::set_threads(int nthread) {
